        ...
        <TouchableOpacity ref={ref} className="w-full flex-row items-center pb-4" {...rest} >
            ...
            <View className="flex-1 ml-3">
                <View className="flex-row items-center">
                    <Text className="text-slate-100 font-subtititle text-base flex-1">{data.title}</Text>
                    {data.quantity && <Text className="text-slate-400 font-subtititle text-sm">x {data.quantity}</Text>}
                </View>
